...
class Evaluation:
    ...
    def inst_regret(self, t, all_paths, selected_path, robot_model, param=None):
        ...
        for path, points in all_paths.items():
            if param is None:
                ...
                value_omni[path] = aqlib.mves(time=t, xvals=points, robot_model=robot_model,
                                              param=(self.max_val).reshape(1, 1))
        ...
        if param is None:
            ...
            value_selected = aqlib.mves(time=t, xvals=selected_path, robot_model=robot_model,
                                        param=(self.max_val).reshape(1, 1))
    ...
    def update_metrics(self, t, robot_model, all_paths, selected_path, value=None, max_loc=None, max_val=None,
        ...
        if self.reward_function == 'naive' or self.reward_function == 'naive_value':
            ...
            self.metrics['max_val_regret'][t], self.metrics['mes_reward_robot'][t], self.metrics['mes_reward_omni'][
                t] = self.inst_regret(t, all_paths, selected_path, robot_model, param='info_regret')
    ...
    def plot_metrics(self):
        ...
        np.savetxt('./figures/' + self.reward_function + '/metrics.csv', \
                   (time.T, info_gain.T, aqu_fun.T, MSE.T, hotspot_error.T, max_loc_error.T, \
                    ...
                    regret.T, info_regret.T, current_highest_obs.T, current_highest_obs_loc_x.T,
                    current_highest_obs_loc_y.T, \
